...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" SYED RAHIM  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Syed Rahim"$i"                   |"
echo $i" |"$pu" TEAM :"$cy"~ [ALoNe] [HACKER] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%District.S%] [KURRAM]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 03168823296"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" saidrahim4ever@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i""
sleep 2
echo $ku"WhatsApp :"$i" 03168823296"
echo $ku"Facebook :"$i" SYED RAHIM"
sleep 2
echo $pur">> Thanks For Use My Tool<<"
exit
fi
